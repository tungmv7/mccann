...
/*                         array(
						...
						array(
                            ...
                            'compiler' => 'true',
                            //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( 'Upload your website\'s custom loader image.', 'redux-framework-demo' ),
                            //'default'  => array( 'url' => get_template_directory_uri().'/assets/img/logo.png' ),
						...
						array(
							...
							'title'          => __( 'Dimensions of loader image (Width/Height) Option', 'redux-framework-demo' ),
							//'subtitle'       => __( 'Please choose if is needed custom dimensions width and height Default is 60px x 60px.', 'redux-framework-demo' ),
							'desc'           => __( 'Please choose if is needed custom dimensions width and height Default is 60px x 60px.', 'redux-framework-demo' ),
							'default'        => array(
								'width'  => 60,
								'height' => 60,
							),
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'options'  => array( 'main' => 'Default Navbar', 'black' => 'Black Navbar', 'white' => 'White Navbar' ),
                            'default'  => 'main',
                        ),
                        /*array(
                            'id'       => 'switch_social',
                    ...
                    'fields'     => array(
                       /* array(
                        ...
                        array(
                            ...
                            'desc'     => __('Select your theme alternative color scheme.', 'redux-framework-demo'),
							'presets' => true,
                            'options'  => array(
                                'default.css' => 'Default',
                                'blue.css' => 'Blue',
								...
								'redbright.css' => 'RedBright',
								'bluegrey.css' => 'BlueGrey',
								'custom' => 'Custom',
                            ),
                            'default'  => 'default.css',
						...
						array(
                            'id'       => 'th_custom_color',
                            'type'     => 'color',
							'required' => array( 'th_select_stylesheet', '=', 'custom' ),
                            'title'    => __( 'Custom theme color', 'redux-framework-demo' ),
                            'subtitle' => __( 'Pick a color for the theme elements (default: #d72363).', 'redux-framework-demo' ),
                            'default'  => '#d72363',
                            'validate' => 'color',
                        ),
						array(
                            ...
                            'subtitle' => __( 'Pick a color for the theme on hover (default: #AF1D50).', 'redux-framework-demo' ),
                            'default'  => '#AF1D50',
                            'validate' => 'color',
                        ),
                        array(
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
                        array(
                            'id'       => 'th_footer_style',
                            'type'     => 'select',
                            'title'    => __('Footer style', 'redux-framework-demo'),
                            'desc'     => __('Select an appropriate style for the footer.', 'redux-framework-demo'),
                            'options'  => array(
                                'style1' => 'Style1',
                                'style2' => 'Style2',
                            ),
                        ...
                        array(
                            ...
                            'type'     => 'media',
                            'url'      => true,
                            'title'    => __( 'Footer logo image', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( 'Upload your footer website\'s logo image.', 'redux-framework-demo' ),
                            'default'  => array( 'url' => get_template_directory_uri().'/assets/img/logo.png' ),
                        ),
                        array(
                            ...
                            'type'     => 'media',
                            'url'      => true,
                            'title'    => __( 'Footer retina logo image', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( 'Footer retina logo should be 2x larger than Custom Logo (field is optional).', 'redux-framework-demo' ),
                            'default'  => array( 'url' => get_template_directory_uri().'/assets/img/logo@2x.png' ),
                        ),
                        array(
                            'id'       => 'footer_text',
                            ...
                            'default'  => '&#169; 2015 ROOK Agency, Ltd.  |   Branding. Print. Web. Strategy.',
                        ),
                        array(
                        ...
                        array(
                            ...
                            'desc' => __('Your Linkedin URL', 'redux-framework-demo' ),
                        ),
                        array(
                            ...
                            'title' => __('Custom Social URL', 'redux-framework-demo' ),
                            'subtitle' => __('Your Social URL', 'redux-framework-demo' ),
                            'description'=>__('Ex: &#x3C;li&#x3E;&#x3C;a href=&#x22;#x&#x22;&#x3E;Facebook&#x3C;/a&#x3E;&#x3C;/li&#x3E;', 'redux-framework-demo' )
                        ),
						array(
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
						...
						array(
                            ...
                            'type'     => 'media',
                            'url'      => true,
                            'title'    => __( 'Caption image', 'redux-framework-demo' ),
                            'compiler' => 'true',
                            //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                            'desc'     => __( 'Upload your portfolio custom caption image.', 'redux-framework-demo' ),
                            //'default'  => array( 'url' => get_template_directory_uri().'/assets/img/logo.png' ),
                        ),
                    ),
                );
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
                        array(
                            ...
                            'desc'     => __( 'Add your blog title. Will be displayed on the main blog page', 'redux-framework-demo' ),
                            //'validate' => 'numeric',
                            //'default'  => '70',
                        ),
                        array(
                            ...
                            'desc'     => __( 'Add your blog subtitle. Will be displayed on the main blog page', 'redux-framework-demo' ),
                            //'validate' => 'numeric',
                            //'default'  => '70',
                        ),
                        array(
...
/*                 $this->sections[] = array(
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'menu_title'           => __( 'ROOK', 'redux-framework-demo' ),
                    'page_title'           => __( 'ROOK', 'redux-framework-demo' ),
...
/*                 $this->args['admin_bar_links'][] = array(
                ...
                $this->args['admin_bar_links'][] = array(
                    //'id'    => 'redux-support',
                    'href'   => 'http://themeforest.net/user/wossthemes',
...
/*                 $this->args['share_icons'][] = array(
                ...
                $this->args['share_icons'][] = array(
                    'url'   => 'https://www.facebook.com/wossthemes',
                    'title' => 'Like us on Facebook',
                    'icon'  => 'el-icon-facebook'
                );
                $this->args['share_icons'][] = array(
                    'url'   => 'https://twitter.com/WossThemes',
                    'title' => 'Follow us on Twitter',
                    'icon'  => 'el-icon-twitter'
                );
                $this->args['share_icons'][] = array(
                    'url'   => 'http://themeforest.net/user/wossthemes',
                    'title' => 'Find us on ThemeForest',
                    'icon'  => 'el-icon-th-list'
                );
				$this->args['share_icons'][] = array(
                    'url'   => 'mailto:support@wossthemes.com',
